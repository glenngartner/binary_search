...
A console application that implements iterative and recursive binary search algorithms.
The application automatically generates a random list of integers, and searches that list for values.
...
```bash
git clone https://github.com/glenngartner/binary_search.git
```
